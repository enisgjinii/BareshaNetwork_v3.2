...
<body>
    ...
    ?>
        <div class="container my-5">
            <a href="lista_kontratave_gjenerale.php" class='btn btn-light text-capitalize border border-1 shadow-2 my-3' id="backBtn" data-mdb-toggle="tooltip" title="Shko prapa"><i class="fas fa-arrow-left "></i> Back</a>
            ...
            <div class="card  shadow-sm border py-5 px-5">
                ...
                <div class="row">
                    ...
                    <p>This document specifies the terms and conditions of the agreement between <b>Baresha Music SH.P.K</b> , located at Rr. Brigada 123 nr. 23 in Suharek&euml;, represented by <b>AFRIM KOLGECI, CEO-FOUNDER of Baresha Music</b>, and <b>ARTIST: <?php
                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                echo $nameAndEmail[0];
                                                                                                                                                                                                                                                                ?></b>, a citizen of <b> Kosovo </b>, with personal identification number <b><?php echo $row['numri_personal'] ?></b>. <?php echo $nameAndEmail[0]; ?> will be representing themselves on the other side of this agreement through their YouTube channel identified by the</p>
                ...
                <div class="row">
                    ...
                    <p>If the rules mentioned above are to happen the artist must pay to Baresha Music SH.P.K between 20.000 and 40.000 Euros + <b><?php echo $row['vat'] ?></b> for the damages caused to Baresha Music.</p>
                    </p>
                    ...
                    <p> N&euml;se ndodh&euml; q&euml; rregullat e m&euml;sip&euml;rme t&euml; thyhen, artisti duhet t'i paguaj&euml; Baresha Music SH.P.K nga 20.000 deri n&euml; 40.000 Euro + <b> <?php echo $row['vat'] ?></b> p&euml;r d&euml;met e shkaktuara n&euml; Baresha Music.</p>
                ...
                <div class="row">
                    ...
                    <p class="fw-bold">Eng. :</p>
                    <p><b>6.1.</b> Baresha Music SH.P.K shall pay the artist with a sum of 80.00% of gross income for YouTube and 50% for Digital Store sales.</p>
                    <p class="fw-bold">Shqip. :</p>
                    <p><b>6.1.</b> Baresha Music SH.P.K do t&euml; paguaj&euml; artistin me nj&euml; shum&euml; prej 80.00% t&euml; t&euml; ardhurave bruto p&euml;r shitjet n&euml; YouTube dhe 50% p&euml;r shitjet n&euml; shitoret dixhitale.</p>
                    <p class="fw-bold">Eng. :</p>
                    <p class="fw-bold">Shqip. :</p>
                ...
                <div class="row">
                    ...
                    <p>This Contract is Signed on – Kjo kontrat&euml; n&euml;shkruhet m&euml; - : 10/03/2022</p>
