...
$minDate = isset($_POST['minDateBiz']) ? $_POST['minDateBiz'] : '';
$maxDate = isset($_POST['maxDateBiz']) ? $_POST['maxDateBiz'] : '';

// Retrieve additional filtering parameters
$clientName = isset($_POST['clientNameBiz']) ? $_POST['clientNameBiz'] : '';
$bankInfo = isset($_POST['bankInfoBiz']) ? $_POST['bankInfoBiz'] : '';
$paymentType = isset($_POST['paymentTypeBiz']) ? $_POST['paymentTypeBiz'] : '';
