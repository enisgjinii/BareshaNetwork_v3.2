                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            ...
                            <a href="api/delete_methods/delete_file.php?id=<?php echo $k['id']; ?>" class="btn btn-danger" onclick="return confirm('Are you sure you want to delete this entry?')"><i class="fi fi-rr-trash"></i></a>
                          </td>
                        </tr>
                      <?php } ?>
                    </tbody>
