...
// Force token expiration to ensure fresh data
...
if (!$track_stmt->execute()) {
    error_log("Error inserting user activity: " . $track_stmt->error);
}
$track_stmt->close();
...
<head>
    ...
    ?>
    <!-- Get the page name and set the title -->
    <?php
