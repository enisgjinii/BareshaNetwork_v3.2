                            ...
                            <div class="accordion-item border-1 rounded-5">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                                    <div class="accordion-body">
                                        ...
                                        <input type="text" name="emri" id="emri" class="form-control rounded-5 border border-2 " placeholder="Shëno emrin e klientit" required>
                                        <br>
                                        <label for="mbiemri_klientit" class="form-label">Mbiemri</label>
                                        <input type="text" name="mbiemri" id="mbiemri" class="form-control rounded-5 border border-2" placeholder="Shëno mbiemrin e klientit" required>
                                        <br>
                                        <label for="numri_i_telefonit" class="form-label">Numri i telefonit</label>
                                        <input type="tel" name="numri_tel" id="numri_tel" class="form-control rounded-5 border border-2" placeholder="Shëno numrin e telefonit">
                                        <br>
                                        <label for="numri_personal" class="form-label">Numri personal</label>
                                        <input type="number" name="numri_personal" id="numri_personal" class="form-control rounded-5 border border-2" placeholder="Shëno numrin personal">
                                    </div>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <div class="accordion-body">
                                        <div class="col">
                                            <div class="row">
                                                ...
                                                <div class="col-auto">
                                                    <span class="text-muted d-block mt-2 mb-3" style="font-size: 12px;">Në mungesë të klientit, kaloni te regjistrimi i klientit të ri.</span>
                                        ...
                                        <input type="text" name="email" id="email" class="form-control rounded-5 border border-2" placeholder="Shëno adresen e email-it" required>
                                        <br>
                                        ...
                                        <input type="text" name="numri_xhiroBanka" id="numri_xhiroBanka" class="form-control rounded-5 border border-2" placeholder="Shëno numrin e xhirollogaris&euml;" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div id="pdp" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#perqindja-accordion">
                                    <div class="accordion-body">
                                        <div class="col">
                                            ...
                                            <input type="number" name="tvsh" id="tvsh" class="form-control rounded-5 border border-2" placeholder="Shëno përqindjen" required>
                                            <br>
                                            <label for="pronari_xhiroBanka" class="form-label">Pronari i xhirollogaris&euml;
                                                bankare</label>
                                            <input type="text" name="pronari_xhiroBanka" class="form-control rounded-5 border border-2" placeholder="Shëno pronarin e xhirollogaris&euml;" required>
                                            <br>
                                            <label for="kodi_swift" class="form-label">Kodi SWIFT</label>
                                            <input type="text" name="kodi_swift" class="form-control rounded-5 border border-2" placeholder="Shëno kodin SWIFT" required>
                                            <br>
                                            <label for="iban" class="form-label">IBAN</label>
                                            <input type="text" name="iban" class="form-control rounded-5 border border-2" placeholder="Shëno IBAN" required>
                                            <br>
                                            <label for="emri_bankes" class="form-label">Emri i bank&euml;s</label>
                                            <input type="text" name="emri_bankes" class="form-control rounded-5 border border-2" placeholder="Shëno emrin e bank&euml;s" required>
                                            <br>
                                            <label for="adresa_bankes" class="form-label">Adresa e bank&euml;s</label>
                                            <input type="text" name="adresa_bankes" class="form-control rounded-5 border border-2" placeholder="Shëno adresen e bank&euml;s" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
