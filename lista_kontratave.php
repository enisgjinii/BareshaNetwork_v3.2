                        ...
                        <div class="col-12">
                            ...
                            ' . '<i class="fi fi-rr-download"></i>' . '
                                                ...
                                                <td style="font-size: 12px;" class="wrap-text">
                                                    ...
                                                    <?php } else {
                                                    ?>
                                                        <button type="button" class="btn btn-success rounded-5 text-white" data-bs-toggle="modal" data-bs-target="#exampleModal" data-id="<?php echo $k['id']; ?>" data-email="<?php echo $k['klient_email']; ?>" onclick="updateEmailInput(this)" data-link="https://panel.bareshaoffice.com/BareshaNetwork_v3.2/kontrataPerKlient.php?id=">
