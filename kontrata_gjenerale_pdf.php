        ...
        <div id="contractContent" class="container my-5">
            <div class="py-5 px-5">
                ...
                <div class="row">
                    ...
                    <div class="float-start">
                        <p class="fw-bold">Date – Datë: <?php echo date('d/m/Y', strtotime($row['data_e_krijimit'])); ?></p>
                    </div>
                </div>
                <br>
                <div class="row">
                    <p class="fw-bold">Eng. :</p>
                    <p>This document specifies the terms and conditions of the agreement between <b>Baresha Music SH.P.K</b> , located at Rr. Brigada 123 nr. 23 in Suharekë, represented by <b>AFRIM KOLGECI, CEO-FOUNDER of Baresha Music</b>, and <b>ARTIST:
                            <?php
                    ...
                    <p>Ky dokument specifikon kushtet dhe kushtëzimet e marrëveshjes midis Baresha Music SH.P.K, me adresë Rr. Brigada 123 nr. 23 në Suharekë, e përfaqësuar nga <b>AFRIM KOLGECI, CEO-FOUNDER i Baresha Music</b>, dhe <b>ARTISTI: <?php echo $nameAndEmail[0]; ?></b>, qytetar i <b> <?php echo $row['shteti'] ?></b>, me numër personal identifikimi <b> <?php echo $row['numri_personal'] ?> </b>.<?php echo $nameAndEmail[0]; ?> do të përfaqësohet nga ana e tyre në këtë marrëveshje përmes kanalit të tyre në YouTube të identifikuar me YouTube ID - <b><?php echo $row['youtube_id'] ?></b> dhe emrin e kanalit - <b>Baresha Music.</b></p>
                    ...
                    <p><b>1.1. Artisti - Pronari i të Drejtave </b>- përfaqsion një person fizik ose juridik që përfaqëson veten, një grup ose një bandë, që autorizon Baresha Music SH.P.K.</p>
                    <p>Eng. :</p>
                    ...
                    <p>Shqip. :</p>
                    <p><b>1.2. Baresha Music SH.P.K </b>- Përdoruesi i të Drejtave - përfaqson kompaninë që mbart të drejta ekskluzive për shpërndarjen, shitjen dhe publikimin e masterit audio dhe video në platformat e YouTube dhe dyqanet dixhitale nën këtë kontratë siq cekët në nenin 1.3.</p>
                ...
                <div class="row">
                    ...
                    <p>
                    <p><b>Shqip. :</b></p>
                    <p><b>3.1. Artisti (Pronari i të Drejtave)</b> do të autorizojë <b> veprat e tij të mëparshme dhe të ardhshme</b>, të ngarkuara potencialisht në kanalin e tij në YouTube, në dispozicion të <b> Baresha Music SH.P.K (Përdoruesi i të Drejtave)</b>, nën një kontratë të veqant. Kontrata e të Drejtave do t'i japë Përdoruesit të Copyright-it të drejtën për të përdorur veprat pa një kohëzgjatje të caktuar. Në rast të ndërprerjes së Kontratës së Bashkëpunimit,<b> Baresha Music SH.P.K (Përdoruesi i Copyright-it)</b> do t'i kthejë të gjitha të drejtat Artistit (Pronarit të Drejtave) brenda 30 ditëve nga ndërprerja e Kontratës së Bashkëpunimit. </p>
                    </p>
                    <p><b>Eng. :</b></p>
                    ...
                    <p><b>Shqip. :</b></p>
                    <p><b>3.2.</b> Nëpërmjet nënshkrimit të kësaj kontrate, Artisti autorizon Baresha Music SH.P.K për të përdorur të gjitha videot në kanalin e tij për promovimin e klientëve të tjerë në Baresha Music SH.P.K duke përdorur "End Screens" dhe "Cards". </p>
                    <p><b>Eng. :</b></p>
                    ...
                    <p>Nëse artisti i dërgon Baresha Music SH.P.K ndonjë projekt muzikor si (Audio, Video) të çfarëdo lloji ose publikon vetë në kanalin e tij/saj gjatë kohës që është në BASHKËPUNIM me Baresha Music SH.P.K që përmban.</p>
                    <ul style="margin-left:50px;list-style-type:none;">
                        <li>- Free Beats (Pa licencë)</li>
                        <li>
                            - Instrumentale dhe gjithashtu Beats (Pa licencë)
                        </li>
                        <li>- Vokale që përmbajnë vepra të tjera të artistit (Pa aprovim nga pronari original)</li>
                        <li>- Tekste të paautorizuara që përmbajnë vepra të tjera artistësh (Pa miratimin e tyre)</li>
                        <li>- Video që përmbajnë vepra të tjera të artistëve (Pa miratimin e tyre)</li>
                    </ul>
                    <p> Nëse ndodhë që rregullat e mësipërme të thyhen, artisti duhet t'i paguajë Baresha Music SH.P.K nga 20.000 deri në 40.000 Euro për dëmet e shkaktuara në Baresha Music.</p>
                    </p>
                    <p><b>Eng. :</b></p>
                    ...
                    <p><b>Shqip. :</b></p>
                    <p><b>3.4.</b> Artisti me këtë deklaron se ka shqyrtuar me kujdes rregulloret dhe udhëzimet themelore të paraqitura në këtë marrëveshje, dhe duke vendosur nënshkrimin e tyre në këtë marrëveshje, ata konfirmojnë pranimin dhe pajtimin e tyre për të respektuar kushtet e saj siq jan me poshtë.</p>
                    <p><b>3.4.1</b> Nuk do të ndryshoj ose manipuloj asnjë aspekt të lidhur me YouTube-n, dhe deklaron me qartësi se do të ndaloj të modifikoj, redaktoj ose krijoj përmbajtje për "Tags", "Metadata", "Description", "Hashtags", "Channel Tags" ose "Thumbnail" të çdo materiali.
                        Përdorimi i emrave që i takojnë artistëve tjerë ose markave të regjistruara pa autorizimin me shkrim të pronarit të tyre është kategorikisht i ndaluar. Mosrespektimi i kësaj rregulle nga ARTISTI mund të çojë në përgjegjësi ligjore për çdo dëm potencial që mund të shkaktohet, duke përfshirë dëmshpërblim financiar.
                    </p>
                    <p><b>3.4.2</b> ARTISTI duhet të ndalojë ngarkimin e çdo lloj përmbajtjeje në YouTube që përfshin çdo material, duke përfshirë por jo duke u kufizuar me audio, video, instrumentale, melodi, tekst, foto, imazh, person, logo ose markë tregtare që nuk i takojnë atij dhe për të cilat ai nuk ka autorizim me shkrim nga pronari i tyre. Mosrespektimi i kësaj rregulle mund të çojë në përgjegjësi ligjore për çdo dëm potencial që mund të shkaktohet, duke përfshirë dëmshpërblim financiar.</p>
                    <p><b>3.4.3</b> ARTISTI është i ndaluar të heqë nga roli i caktuar si "Owner", "Manager" ose "Editor" i caktuar nga Baresha Music pa nënshkrimin e një kontrate. Në rast se ndodh një ngjarje e tillë, ARTISTI duhet të rikthejë personat e hequr brenda 48 orëve. Mosrespektimi i kësaj rregulle do të rezultojë në një gjobë ditore prej 20 Euro për çdo ditë pas limitit të dy ditëve deri në momentin që rolet e "Owner", "Manager" ose "Editor" kthehen te përfaqësuesit e Baresha Music.</p>
                    <p><b>Eng. :</b></p>
                    <p>
                ...
                <div class="row">
                    ...
                    <p><b>Shqip. :</p></b>
                    <p><b>4.1.</b> Baresha Music SH.P.K do të mbajë të drejtën ekskluzive për të shpërndarë përmbajtjen audio dhe video të Artistit në kanalin e tij të YouTube-s si dhe në të gjitha platformat dixhitale.
                    </p>
                    <p><b>Eng. :</b></p>
                    ...
                    <p><b>Shqip. :</b></p>
                    <p><b>4.2.</b> Baresha Music SH.P.K do të shpërndajë materialet e dërguara nga artisti në YouTube dhe dyqanet dixhitale, siç është specifikuar në këtë kontratë.</p>
                    <p><b>Eng. :</b></p>
                    ...
                    <p><b>Shqip. :</b></p>
                    <p><b>4.4.</b> Baresha Music SH.P.K do t'i dërgojë Artistit 1 (një) video për "Instagram Story" maksimumi dhe 1 (një) video për "Instagram Feed" për secilin Artist në një këngë, me rregullat e lart cekur të nenit 3.3.</p>
                    <p class="fw-bold">Eng. : </p>
                    ...
                    <p class="fw-bold">Shqip. :</p>
                    <p><b>4.5.1.</b> Për YouTube - Që të promovojnë këngën e tyre, Baresha Music SH.P.K mund të shfaq reklama në formën e banerave ose klipave reklamuese në ose para materialit (ose albumeve) të Pronarit të të Drejtave të Autorit në YouTube.</p>
                    <p class="fw-bold">Eng. : </p>
                    ...
                    <p class="fw-bold">Shqip. :</p>
                    <p><b>4.5.2.</b> Baresha Music SH.P.K do të kryejë një proces të hollësishëm vlerësuese për të zbuluar dhe bllokuar çdo video të materialit të ngarkuara nga palë të treta pa autorizim. Në rast se këto punë lejohen, kompania mund të vendosë t'i monetizojë ato.</p>
                    <p class="fw-bold">Eng. : </p>
                    ...
                    <p class="fw-bold">Shqip. :</p>
                    <p><b>4.5.3.</b> Baresha Music SH.P.K është e vendosur që të heqë menjëherë çdo video të materialit që ngarkohen nga palë të treta pa autorizim.</p>
                    <p class="fw-bold">Eng. : </p>
                    ...
                    <p class="fw-bold">Shqip. :</p>
                    <p><b>4.5.5.</b> Baresha Music SH.P.K është e vendosur të mbajë integritetin e imazhit dhe reputacionit të artistëve të saj. Me këtë qëllim, kompania do të heqë çdo material të paligjshëm që publikohet në lidhje me artistin në YouTube dhe platforma të tjera të "Përmbajtjes së Krijuar nga Përdoruesit" si SoundCloud, DailyMotion etj.</p>
                    <p class="fw-bold">Eng. : </p>
                    ...
                    <p class="fw-bold">Shqip. :</p>
                    <p><b>4.6.</b> Baresha Music SH.P.K merr autorizimin e nevojshëm nga Artisti, i cili është pronari i të drejtave të autorit, për të ushtruar ekskluzivisht të drejtën për të përfituar nga të ardhurat e mëposhtme:</p>
                    <p class="fw-bold">Eng. : </p>
                    ...
                    <p class="fw-bold">Shqip. :</p>
                    <p><b>4.6.1.</b> Gjatë kohëzgjatjes së kësaj marrëveshje kontraktuale, kompania do të jetë e autorizuar për të angazhuar veten në shpërndarjen, publikimin dhe shitjen e përmbajtjes audio dhe video të Artistit në kanalin YouTube të Artistit, si dhe në të gjitha dyqanet dixhitale.</p>
                    <p class="fw-bold">Eng. : </p>
                    ...
                    <p class="fw-bold">Shqip. :</p>
                    <p><b>4.6.2.</b> Vendosja e reklamave, duke përfshirë flamuj ose klipet, para ose gjatë shfaqjes së punëve ose albumeve të Artistit, si dhe të gjitha materialet e tjera të paraqitura nga Artisti që gjenerojnë fitime, ashtu siç është specifikuar në këtë marrëveshje, do të autorizohet.</p>
                    <p class="fw-bold">Eng. : </p>
                    ...
                    <p class="fw-bold">Shqip. :</p>
                    <p><b>4.7.</b> Baresha Music SH.P.K është e detyruar të njoftojë Artistin në kohë çdo katër muaj, siç është përcaktuar në kushtet e kësaj marrëveshje kontraktuale, për të gjitha pagesat që tejkalojnë 100 euro dhe janë bërë në Dyqanet Dixhitale. Nëse kjo shumë minimale nuk është arritur, pagesa do të shtyhet për në periudhën e pagesave të ardhshme, derisa kufiri minimal të arrihet. Ky protokoll i njëjtë aplikohet edhe për pagesat e YouTube, ku pagesat bëhen çdo muaj.</p>
                    <p class="fw-bold">Eng. : </p>
                    ...
                    <p class="fw-bold">Shqip. :</p>
                    <p><b>4.8.</b> Sipas kushteve të kësaj marrëveshje, Baresha Music SH.P.K rezervon të drejtën për të marrë pushime dhe për të festuar ditët zyrtare të Republikës së Kosovës dhe gjatë këtyre ditëve ne nuk pranojmë asnjë publikim të ri - prandaj, çdo publikim duhet të dërgohet një ditë më parë.</p>
                    <p class="fw-bold">Eng. : </p>
                    ...
                    <p class="fw-bold">Shqip. :</p>
                    <p><b>4.9.</b> Në rast se artisti vendos të shesë kanalin e tij një artist tjetër ose një kompanie tjetër, Baresha Music SH.P.K rezervon të drejtën për të mbajtur 100% të ardhurave për atë muaj të caktuar. Në të njëjtën kohë, kërkojmë që një kontratë që përmban kushtet dhe parimet e shitjes të paraqitet për shqyrtim dhe aprovim tek ne. Kjo është për të siguruar që pronari i ri i kanalit është i vetëdijshëm për obligimet e tij ndaj Baresha Music SH.P.K dhe që të ardhurat e ardhshme drejtohen tek pala e duhur.
                    <p class="fw-bold">Eng. : </p>
                    ...
                    <p class="fw-bold">Shqip. :</p>
                    <p><b>4.10.</b> Në rast se artisti nuk publikon asnjë lloj përmbajtjeje të re brenda një viti, Baresha Music SH.P.K rezervon të drejtën për të shfuqizuar këtë kontratë dhe çdo kontratë tjetër me artistin. Në këtë rast, kanali do të humbasë monetizimin.
                    </p>
                </div>
                <div class="row">
                    ...
                    <p class="fw-bold">Shqip. :</p>
                    <p><b>5.3.</b> Sipas kushteve të kësaj marrëveshje, artisti ka të drejtë të marrë të ardhurat nga shpërndarja dhe shitja e master audio dhe / ose video nga Baresha Music SH.P.K në YouTube dhe në të gjitha dyqanet dixhitale.</p>
                    <p class="fw-bold">Eng. :</p>
                    ...
                    <p class="fw-bold">Shqip. :</p>
                    <p><b>5.4.</b> Artisti do të publikojë, distribuojë dhe shesë master audio dhe video në kanalin e tij të YouTube dhe në dyqanet dixhitale vetëm përmes Baresha Music Sh.P.K për kohën e kontratës.
                    </p>
                    <p class="fw-bold">Eng. :</p>
                    ...
                    <p class="fw-bold">Shqip. :</p>
                    <p><b> 5.6.</b> Artisti deklaron dhe garanton se gjatë kohës që kjo kontratë është në fuqi, ai nuk do të hapë një kanal të ri në YouTube ose dyqane dixhitale (si Spotify, Apple Music, etj.). Artisti deklaron se nuk do ta bëjë këtë as si person dhe as përmes një kompanie tjetër ose një individi tjetër.
                    ...
                    <p class="fw-bold">Shqip. :</p>
                    <p><b>5.7.</b> Eshtë detyrë e artistit të dërgojë materialet e tij / video / audio tek Baresha Music, 24 orë para datës së planifikuar të lansimit. Kjo do ti japë kohë Baresha Music për të finalizuar procesin e marketingut të përmbajtjes / për të siguruar një lansim të suksesshëm.
                    </p>
                    <p class="fw-bold">Eng. :</p>
                    <p>
                    ...
                    <p class="fw-bold">Shqip. :</p>
                    <p><b>5.8.</b> Artisti është i detyruar të kontrollojë nëse kanali i tij përmban materiale që nuk janë të tij dhe t'i largojë ato nga kanali në mënyrë që të përputhen me rregullat e YouTube për "Reused Content".
                    </p>
                </div>
                <div class="row">
                    ...
                    <p class="fw-bold">Shqip. :</p>
                    <p>Te ardhurat e gjeneruara nga shpërndarja, publikimi dhe shitja e masterit audio dhe video të artistit në kanalin e tij të YouTube dhe dyqanet dixhitale do të transferohen në llogarinë bankare të caktuar nga Baresha Music SH.P.K.
                    </p>
                    <p class="fw-bold">Eng. :</p>
                    ...
                    <p class="fw-bold">Shqip. :</p>
                    <p><b>6.1.</b> Baresha Music SH.P.K do të paguajë artistin me një shumë prej <?php echo $row['tvsh'] ?>.00 % të të ardhurave bruto për shitjet në YouTube dhe 50% për shitjet në shitoret dixhitale.</p>
                    <p class="fw-bold">Eng. :</p>
                    <p class="fw-bold">Shqip. :</p>
                    ...
                    <p>Pagesat për Artistin nga Baresha Music SH.P.K do të bëhen nëpërmjet llogaris bankare të cekur si më poshtë:</p>
                    <p>Account Holder – Pronari I Xhiro-Llgarisë: <b><?php echo $row['pronari_xhirollogarise'] ?></b></p>
                    <p> Account Number - Numri Xhiro-Llgarisë: <b><?php echo $row['numri_xhirollogarise'] ?></b> </p>
                    <p>Swift Code – Kodi Swift: <b><?php echo $row['kodi_swift'] ?></b></p>
                    <p>IBAN: <b><?php echo $row['iban'] ?></b></p>
                    <p>Bank Name – Emri Bankës: <b><?php echo $row['emri_bankes'] ?></b></p>
                    <p>Bank Address – Adresa Bankës: <b><?php echo $row['adresa_bankes'] ?></b> </p>
                    <p class="fw-bold">Eng. :</p>
                    <p class="fw-bold">Shqip. :</p>
                    ...
                    <p class="fw-bold">Shqip. :</p>
                    <p><b>6.2.1.</b> Artisti duhet të bëjë pages prejë 100 EURO/vit për botim, shpërndarje, zhvillim tëmarketingut, rritjen e suksesit të këngës, shitjen dhe mirëmbajtjen e llogarisë së artistit në YouTube dhe dyqane dixhitale. Pagesa për koston administrative për vitin e parë duhet të bëhet paraprakisht.</p>
                    <p class="fw-bold">Eng. :</p>
                    ...
                    <p class="fw-bold">Shqip. :</p>
                    <p><b>6.2.2.</b> Komisionet bankare për transferimin e fondeve do të paguhen nga artisti.</p>
                </div>
                <div class="row">
                    ...
                    <p class="fw-bold">Shqip. :</p>
                    <p><b>7.1.</b> Secila palë kontraktuese është përgjegjëse dhe e detyruar të paguajë detyrimet tatimore që dalin nga të ardhurat që fitohen nën këtë kontratë. Bazuar në Ligjin nr. 06/L-105 për Tatimin mbi të Ardhurat, në përputhje me Nenin 31.2 "Tatimpaguesit, që paguajn të drejta punësore (Royalties) për personat rezidentë ose jo-rezidentë, duhet të mbajë një taksë prej dhjetë për qind (10%) në kohën e pagesës ose kreditit".</p>
                </div>
                <div class="row">
                    ...
                    <p class="fw-bold">Shqip. :</p>
                    <p><b>8.1.</b> Duke nënshkruar këtë kontratë, Artisti - Pronari i të Drejtave dëshmon se ai posedon të gjitha të drejtat për të përdorur, publikuar, distribuar, shitur si dhe të drejtat, për çdo material audio dhe / ose video që Artisti do të distribuojë dhe publikojë në kanalin e tij në YouTube dhe në Dyqanet Dixhitale, për të cilat Artisti ka bërë të gjitha marrëveshjet e nevojshme, verbale ose të shkruara me palë të treta, dhe që të gjithë këto palë kanë lejuar me vlerë të plotë Artistin për të autorizuar Baresha Music SH.P.K për të distribuar / publikuar çdo material audio dhe video që artisti jep për ta publikuar në kanalin e tij në YouTube dhe në Dyqanet Dixhitale.</p>
                    <p class="fw-bold">Eng. :</p>
                    <p><b>8.2.</b> By signing this contract, the Artist – The Copyright Owner, CERTIFIES that:</p>
                    <p class="fw-bold">Shqip. :</p>
                    <p><b>8.2.</b> Artisti – Pronari i të Drejtave, me nënshkrimin e kësaj kontrate VËRTETON se:</p>
                    <p class="fw-bold">Eng. :</p>
                    ...
                    <p class="fw-bold">Shqip. :</p>
                    <p><b>8.2.1.</b> Artisti konfirmon se nuk ka asnjë përgjegjësi financiare ndaj palëve të treta dhe se Artisti ka kryer të gjitha obligimet financiare ndaj palëve të treta. Në rast se ndonjë obligim financiar i tillë do të lindë në të ardhmen, Artisti do të jetë i përgjegjshëm personalisht për çdo detyrim potencial të tillë.</p>
                    <p class="fw-bold">Eng. :</p>
                ...
                <div class="row">
                    ...
                    <p class="fw-bold">Shqip. :</p>
                    <p><b>9.1.</b> Marrëveshja për bashkëpunim do të jetë e vlefshme për një periudhë prej <?php echo $row['kohezgjatja'] ?> muajsh nga data e nënshkrimit dhe do të rinovohet automatikisht për periudha të mëtejshme prej <?php echo $row['kohezgjatja'] ?> muajsh, përveç rasteve të ndërprerjes. As artisti (pronari i të drejtave të kopjimit) dhe as Baresha Music SH.P.K (përdoruesi i të drejtave të kopjimit) mund të ndërprejnë këtë marrëveshje për bashkëpunim duke siguruar njoftim me shkrim të ndërprerjes së saj të paktën 90 ditë para përfundimit të secilës periudhë. Në rast të ndërprerjes, marrëveshja do të konsiderohet se ka përfunduar në datën në të cilën ajo do të kishte përfunduar natyrshëm. Kjo marrëveshje nuk mund të ndërpritet përpara përfundimit të çdo periudhe, përveç rasteve kur artisti jep njoftim me shkrim të ndërprerjes së saj me arsyetim të vlefshëm nëpërmjet email-it, të paktën 3 muaj përpara përfundimit të marrëveshjes.</p>
                    <p class="fw-bold">Eng. :</p>
                    ...
                    <p class="fw-bold">Shqip. :</p>
                    <p>Palët nënshkruese dëshmojnë se po nënshkruajnë këtë kontratë me vullnet të lirë, pa ndonjë formë prekjeje, mashtrimi ose gënjeshtrë. Duke nënshkruar këtë kontratë, palët dëshmojnë se kanë lexuar me kujdes kontratën dhe nuk kanë asnjë objeksion nën kushtet dhe parimet e në të shkruar.</p>
                    <p class="fw-bold">Eng. :</p>
                    <p class="fw-bold">Shqip. :</p>
                    ...
                    <div class="row">
                        ...
                        <div class="col text-end">
                            <p class="fw-bold"><?php echo $row['emri'] ?>
                            </p>
                        </div>
                    </div>
                    <div class="row">
