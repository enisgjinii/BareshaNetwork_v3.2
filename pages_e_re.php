        ...
        <div class="modal-content">
            <div class="modal-header">
                <div class="flex">
                    ...
                    <p class="text-muted" style="font-size: 12px;">Plot&euml;soni formularin m&euml; posht&euml;
                        p&euml;r t&euml; shtuar nj&euml;
                        pages&euml;.</p>
                ...
                <form id="user_form">
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="text" name="id_of_fatura" id="id_of_fatura"
                                class="form-control input-custom-css" placeholder="Sh&euml;no numrin e fatur&euml;s">
                        </div>
                        <div class="col">
                            <label class="form-label">M&euml;nyra e pages&euml;s</label>
                            <select name="menyra" id="menyra" class="form-select input-custom-css"
                    ...
                    <div class="row my-2">
                        <div class="col">
                            ...
                            <input type="text" name="shuma" id="shuma" class="form-control input-custom-css"
