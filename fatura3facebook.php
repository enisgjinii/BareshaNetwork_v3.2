...
include 'conn-d.php';
$id = $_GET['invoice'];
$resultas = $conn->query("SELECT SUM(`totali`) as `sum` FROM `shitjefacebook` WHERE fatura='$id'");
...
<?php
$gin = $conn->query("SELECT * FROM faturafacebook WHERE fatura='$id'");
...
<body>
    <div class="container my-3">
        ...
        <div style="display: inline-block;">
            <button id="print-button" type="button" class="btn btn-light border my-3" data-mdb-ripple-color="dark"
                style="text-transform:none;"><i class="fi fi-rr-print fa-xl me-2"></i>Printo</button>
            <button id="send-email-btn" type="button" class="btn btn-light border my-3" data-mdb-toggle="modal"
                data-mdb-target="#email-modal" data-mdb-ripple-color="dark" style="text-transform:none;"><i
                    class="fi fi-rr-paper-plane fa-xl me-2"></i>D&euml;rgo</button>
            <button class="btn btn-light border my-3 dropdown-toggle" type="button" id="dropdownMenuButton"
                data-mdb-toggle="dropdown" aria-expanded="false">
                <i class="fi fi-rr-download fa-xl me-2"></i>Shkarko
            </button>
            <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                <li><a class="dropdown-item" href="#" id="download-pdf-link"><i
                            class="fi fi-rr-file-pdf fa-lg me-2"></i>PDF</a></li>
        ...
        <div class="row gap-2 border rounded-3 p-2 shadow-2">
            ...
            <div class="col p-2 border rounded-3 text-end">
                <b>T&euml; dh&euml;nat e fatur&euml;s "
                    <?php echo $_GET['invoice']; ?>"
                </b>
                <hr>
                <table class="table table-bordered" id="tabelaKlientit">
                    ...
                    <tr>
                        <td>Adresa</td>
                        <td class="text-end">
                            <?php echo $gstai2['adresa']; ?>
                        </td>
                    </tr>
                    <tr>
                        <td>Numri identifikues i biznesit</td>
                        <td class="text-end">
                            <?php echo $gstai2['emailadd']; ?>
                        </td>
                    </tr>
                    <tr>
                        <td>Data</td>
                    ...
                    <tbody>
                        ...
                        while ($row = $result->fetch_array()) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php echo $row['klientit']; ?>
                                </td>
                                <td>
                                    <?php echo $row['mbetja']; ?>
                                </td>
                                <td>
                                    <?php echo $row['totali']; ?> &euro;
                                </td>
                                <?php
                                $rendori++;
                        }
        ...
        <div class="row gap-2 mt-3 border rounded-2 p-2">
            <table class="table table-bordered caption-top" id="tabelaPagesat">
                <caption>
                    Lista e pagesave t&euml; kryera p&euml;r klientin "
                    <?php echo $gstai2['emri']; ?>"
                </caption>
                <thead class="bg-light">
                    <tr>
