              ...
              <div class="modal-content">
                ...
                <div class="modal-body">
                  <div class="table-responsive">
                    <table class="table w-full" id="paauthenticated_channels">
                          ...
                          <tr>
                            ...
                            <td>
                              <span class="badge bg-warning rounded-pill">
                                Ky klient nuk posedon regjistrim te kanalit te Youtubes në tabelën e refresh tokens, të lutem rishikoje
                              </span>
                            </td>
                          </tr>
                        <?php
          ...
          <div class="col-md-4">
            <div class="card rounded-5  my-3">
              <div class="card-body">
                ...
                <p class="card-text">Data e kontrates: <span class="text-success"><?php echo isset($row['data_kontrates']) ? $row['data_kontrates'] : ''; ?></span>
                </p>
              </div>
            </div>
          </div>
...
<script>
  $(document).ready(function() {
    $('#paauthenticated_channels').DataTable({
