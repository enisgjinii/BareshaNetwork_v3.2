...
if (isset($_POST['btn_save'])) {
    ...
    if ($conn->query("INSERT INTO pagesatfacebook (fatura, shuma, menyra, data, pershkrimi, kategoria) VALUES ('$fatura', '$shuma', '$menyra', '$data', '$pershkrimi', '" . mysqli_real_escape_string($conn, $kategorizimi) . "')")) {
