        ...
        <div class="container-fluid">
            <ul class="nav nav-pills bg-white my-2 mx-0 rounded-5" style="width: fit-content; border: 1px solid lightgrey;" id="pills-tab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link rounded-5 <?php if (isset($_GET['tab']) && $_GET['tab'] == 'profile') echo 'active'; ?>" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" style="text-transform: none;" aria-selected="<?php if (isset($_GET['tab']) && $_GET['tab'] == 'profile') echo 'true';
                                                                                                                                                                                                                                                                                                                        else echo 'false'; ?>">
                ...
                <!-- Register Tab -->
                <li class="nav-item" role="presentation">
                    <button class="nav-link rounded-5 <?php if (!isset($_GET['tab']) || $_GET['tab'] == 'register') echo 'active'; ?>" id="pills-register-tab" data-bs-toggle="pill" data-bs-target="#pills-register" type="button" role="tab" aria-controls="pills-register" style="text-transform: none;" aria-selected="<?php if (!isset($_GET['tab']) || $_GET['tab'] == 'register') echo 'true';
                                                                                                                                                                                                                                                                                                                            else echo 'false'; ?>">
                ...
                <!-- Registe Track Tab -->
                <li class="nav-item" role="presentation">
                    <button class="nav-link rounded-5 <?php if (!isset($_GET['tab']) || $_GET['tab'] == 'kenge') echo 'active'; ?>" id="pills-kenge-tab" data-bs-toggle="pill" data-bs-target="#pills-kenge" type="button" role="tab" aria-controls="pills-kenge" style="text-transform: none;" aria-selected="<?php if (!isset($_GET['tab']) || $_GET['tab'] == 'kenge') echo 'true';
                                                                                                                                                                                                                                                                                                                else echo 'false'; ?>">
...
<script>
    $('#example').DataTable({
        ...
        buttons: [{
            ...
            className: 'input-custom-css px-3 py-2 me-2'
        }, {
            extend: 'copyHtml5',
