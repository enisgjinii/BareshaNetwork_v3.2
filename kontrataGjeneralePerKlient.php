        ...
        <div class="contract-container">
            ...
            <div class="contract-section">
                ...
                foreach ($articles as $article) {
                    echo "<h5>{$article['title_eng']}</h5>";
                    echo "<h5>{$article['title_alb']}</h5>";
                ...
                <div class="col-md-6 text-center">
                    ...
                    <p class="border-bottom">
                        ...
                        if (file_exists($bm_signature)) {
                            echo '<img src="' . sanitizeInput($bm_signature) . '" alt="Baresha Signature" style="width: 200px; height: auto;">';
                        } else {
                ...
                <div class="col-md-6 text-center">
                    ...
                    <p class="border-bottom">
                        ...
                        if ($artistSignature && file_exists($artistSignature)) {
                            echo '<img src="' . $artistSignature . '" alt="Artisti Signature" style="width: 200px; height: auto;">';
                        } else {
                            echo 'Nënshkrimi nuk është caktuar.';
                        }
                        ?>
