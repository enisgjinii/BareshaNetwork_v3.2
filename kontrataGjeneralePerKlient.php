        ...
        <div class="container my-5">
            <div class="contract-container">
                ...
                <div class="contract-section">
                    ...
                    foreach ($articles as $article) {
                        ...
                        foreach ($article['content'] as $content) {
                            echo "<p><strong>" . ucfirst($content['lang']) . " :</strong></p>";
                ...
                <div class="contract-section">
                    <div class="row">
                        <div class="col">
                            <p><strong>Titulli i kontratës / Contract Title:</strong></p>
                            <p class="border-bottom w-50"><?php echo htmlspecialchars($contract['titulli_kontrates']); ?></p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-md-6 text-center">
                        ...
                        <p class="border-bottom">
                            ...
                            if ($artistSignature && file_exists($artistSignature)) {
                                echo '<img src="' . htmlspecialchars($artistSignature) . '" alt="Artisti Signature" style="width: 200px; height: auto;">';
                            } else {
                                echo 'Nënshkrimi nuk është caktuar.';
                            }
                            ?>
