...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    // Update all rows with the selected period
                    ...
                    <form id="updateForm">
                        ...
                        <div class="row">
                                ...
                                <select name="periods" id="periods" class="form-select">
                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            $accountingPeriod = sanitizeInput($row['AccountingPeriod']);
                            ...
                            <div class="col">
                                ...
                                <input type="text" class="form-control" id="add_currencyValue" name="add_currencyValue" required>
                            </div>
                        </div>
                        <hr>
