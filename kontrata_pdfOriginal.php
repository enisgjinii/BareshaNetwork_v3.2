...
<body>
    <div class="container my-5 py-3">
        <div class="float-start"><a href="lista_kontratave.php"
                class='btn btn-light text-capitalize border border-1 shadow-2' id="backBtn" data-mdb-toggle="tooltip"
                title="Shko prapa"><i class="fas fa-arrow-left "></i> Back</a></div>
        <div class="float-end">
            <button class="btn btn-light text-capitalize border border-1 shadow-2" data-mdb-ripple-color="dark"
                id="printBtn" onClick="printData()"><i class="fas fa-print text-primary "></i> Print</button>
        </div>
        ...
        <div id="contractContent" class="container">
            ...
            <div class="px-5">
                <svg width="100%" height="100%" id="svg" viewBox="0 0 1440 390" xmlns="http://www.w3.org/2000/svg"
                    ...
                    <path
                        d="M 0,400 C 0,400 0,133 0,133 C 72.96666666666667,146.80769230769232 145.93333333333334,160.6153846153846 218,165 C 290.06666666666666,169.3846153846154 361.23333333333335,164.34615384615387 450,154 C 538.7666666666667,143.65384615384613 645.1333333333334,128 742,129 C 838.8666666666666,130 926.2333333333331,147.65384615384616 994,150 C 1061.7666666666669,152.34615384615384 1109.9333333333334,139.3846153846154 1181,134 C 1252.0666666666666,128.6153846153846 1346.0333333333333,130.80769230769232 1440,133 C 1440,133 1440,400 1440,400 Z"
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <p style="f" class="border-bottom float-end w-50 text-end"> <img src="signatures/34.png"
                ...
                <!-- <div class="row mt-5">
                    <div class="col-6">
                        <p style="f" class="fw-bold"> Artisti/Pronar i kompozicionit t&euml; muzik&euml;s <br> <span>Emri dhe Mbiemri </span> </p>
                    </div>
                    <div class="col-6">
                        <p style="f" class="fw-bold text-end"> Nenshkrimi <br> </p>
                    </div>
                ...
                <div class="row">
                    <div class="col-6">
                        <p style="f"> <?php echo $row['emri'] ?> <?php echo $row['mbiemri'] ?> </p>
                    </div>
                    <div class="col-6">
                        <p style="f" class="border-bottom float-end w-50 text-end"> <?php $file_path = $row['nenshkrimi'];
                        echo '<img src="' . $file_path . '" style="width: 150px; height: auto;">'; ?> <br> </p>
                    </div>
                </div>
                <hr>
                <div class="row">
                    <div class="col-6">
                        <p style="f" class="fw-bold"> Pronar i t&euml; drejtave ekskluzive t&euml; eksploatimit t&euml; kompozicionit t&euml; muzik&euml;s <br> <span>Emri dhe Mbiemri </span> </p>
                    </div>
                    <div class="col-6">
                        <p style="f" class="fw-bold text-end"> Nenshkrimi <br> </p>
                    </div>
                ...
                <div class="row">
                    <div class="col-6">
                        <p style="f"> Baresha Music Sh.p.k. </p>
                    </div>
                    <div class="col-6">
                        <p style="f" class="border-bottom float-end w-50 text-end"> <img src="signatures/34.png" style="width: 150px; height: auto;"> <br> </p>
                    </div>
                </div> -->
